...
const CACHE_NAME = 'lisnoir-cache-v241';
...
const CACHE_ASSETS = [
  ...
  'card-water-icegolem.png',
  'card-dark-vampirelord2.png',
  'card-dark-shadowhound.png',
  ...
  'card-fire-magmaturtle.png',
  'card-nature-greenstag.png',
  'card-light-griffin.png',
  ...
  'card-water-stormkraken.png',
  'card-water-deepseiren.png',
  'card-nature-forestwolf.png',
  'card-nature-windranger.png',
  'card-light-holyangel.png',
  'card-dark-shadowbat.png',
  'card-fire-phoenixemperor2.png',
  'card-fire-vulcan.png',
  'card-dark-darksorceress.png',
  ...
  // ---- プレミアムガチャ第1弾 追加カード ----
  'card-fire-redsalamander.png',
  'card-water-aquaspirit.png',
  'card-nature-forestfairy.png',
  'card-light-holyangel2.png',
  'card-dark-soulwraith.png',
  'card-fire-cerberus2.png',
  'card-dark-charon.png',
