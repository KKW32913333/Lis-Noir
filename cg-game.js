...
const CARD_DEFS = {
  ...
  water_serpent:  { name: 'ストームクラーケン', element: 'water',  rarity: 'epic',   cost: 4, atk: 5, hp: 5,  role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'aoeDamage', value: 3 }, skill: '攻撃時、敵全体に3ダメージを与える', image: 'card-water-stormkraken.png', emoji: '🐙' },
  water_seiren:   { name: '深海のセイレーン', element: 'water', rarity: 'legend', cost: 6, atk: 9, hp: 5, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'poisonChance', value: 2, chance: 0.6, turns: 2 }, skill: '攻撃時、60%の確率で毒（2ターン）を付与する（誘惑の歌声）', image: 'card-water-deepseiren.png', emoji: '👑' },
  ...
  water_icewolf:      { name: 'アイスゴーレム',     element: 'water', rarity: 'rare',   cost: 4, atk: 5, hp: 4, role: 'attacker', skillTag: { trigger: 'onPlay', effect: 'refundCost', value: 1 }, skill: '場に出た時、自分のコストを1回復する', image: 'card-water-icegolem.png', emoji: '🧊' },
  ...
  dark_chaosdemon:    { name: 'シャドウハウンド', element: 'dark', rarity: 'epic', cost: 4, atk: 6, hp: 4, role: 'attacker', skillTag: { trigger: 'onPlay', effect: 'aoeDamage', value: 2 }, skill: '場に出た時、敵全体に2ダメージを与える', image: 'card-dark-shadowhound.png', emoji: '🌑' },
  dark_voidreaper:        { name: 'ヴォイドリーパー',   element: 'dark', rarity: 'legend', cost: 6, atk: 9, hp: 6,  role: 'attacker', skillTag: { trigger: 'onKillAttack', effect: 'extraAttackOnKill' }, skill: '敵を撃破した時、行動終了せず続けてもう一度攻撃できる', image: 'card-dark-voidreaper.png', emoji: '💀' },
  dark_nocturnaldragon:    { name: 'ノクターナルドラゴン', element: 'dark', rarity: 'legend', cost: 7, atk: 8, hp: 10,  role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'novaAttack' }, skill: '攻撃時、自分の攻撃力と同じダメージを敵全体に与える', image: 'card-dark-nocturnaldragon.png', emoji: '🐉' },
  dark_lunaelf:            { name: 'ルナエルフ',         element: 'dark', rarity: 'legend', cost: 4, atk: 3, hp: 7,  role: 'defender', skillTag: { trigger: 'onPlay', effect: 'refundCost', value: 2 }, skill: '場に出た時、自分のコストを2回復する', image: 'card-dark-lunaelf.png', emoji: '🦋' },
  dark_nightmarecavalier:  { name: 'ナイトメアキャバリア', element: 'dark', rarity: 'legend', cost: 7, atk: 5, hp: 13, role: 'defender', skillTag: { trigger: 'passiveDamageReduction', value: 0.5 }, skill: '受けるダメージを常に半減する', image: 'card-dark-nightmarecavalier.png', emoji: '🛡️' },
  dark_shadowslime:        { name: 'シャドウスライム',   element: 'dark', rarity: 'legend', cost: 5, atk: 8, hp: 4,  role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'extraDamage', value: 3 }, skill: '攻撃時、追加で3ダメージ', image: 'card-dark-shadowslime.png', emoji: '🟣' },
  spell_orbitalgrimoire:   { name: 'オービタルグリモア', element: 'dark', rarity: 'legend', cost: 5, atk: 0, hp: 0, type: 'spell', target: 'none', effect: { kind: 'draw', value: 3 }, skill: 'カードを3枚引く', image: 'card-dark-orbitalgrimoire.png', emoji: '📖' },
  // ---- 「光耀の祝福」ガチャ限定カード（全て光属性・レジェンド。実際に引くまで所持しない） ----
  light_shirayuki:      { name: '華光の白姫シラユキ', element: 'light', rarity: 'legend', cost: 6, atk: 4, hp: 10,  role: 'defender', skillTag: { trigger: 'passiveDamageReduction', value: 0.25 }, skill: '受けるダメージを常に25%軽減する（純白の加護）', image: 'card-light-shirayuki.png', emoji: '☂️' },
  light_lucius:          { name: '聖導の賢者ルシウス', element: 'light', rarity: 'legend', cost: 5, atk: 5, hp: 7,  role: 'defender', skillTag: { trigger: 'onPlay', effect: 'drawAndRefundCost', value: 2, refundValue: 2 }, skill: '場に出た時、カードを2枚引き、自分のコストを2回復する', image: 'card-light-lucius.png', emoji: '📜' },
  light_starlightunicorn:{ name: 'スターライトユニコーン', element: 'light', rarity: 'legend', cost: 6, atk: 7, hp: 8,  role: 'attacker', skillTag: { trigger: 'onPlay', effect: 'cleanseAndHealAllies', value: 2 }, skill: '場に出た時、味方全体の状態異常を解除し、HPを2回復する', image: 'card-light-starlightunicorn.png', emoji: '🦄' },
  light_stardustwhale:   { name: 'スターダストホエール', element: 'light', rarity: 'legend', cost: 7, atk: 8, hp: 10, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'aoeDamageStunHeal', value: 3, healValue: 2 }, skill: '攻撃時、敵全体に3ダメージを与えて1ターン行動不能にし、味方全体のHPを2回復する', image: 'card-light-stardustwhale.png', emoji: '🐋' },
  light_sunblazenoble:   { name: 'サンブレイズ・ノーブル', element: 'light', rarity: 'legend', cost: 7, atk: 9, hp: 8, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'extraDamage', value: 3 }, skill: '攻撃時、追加で3ダメージ', image: 'card-light-sunblazenoble.png', emoji: '🥂' },
  light_whitegriffon:    { name: 'ホワイトグリフォン', element: 'light', rarity: 'legend', cost: 6, atk: 7, hp: 8,  role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'aoeDamageAtkUpAllies', value: 3, atkUpValue: 2 }, skill: '攻撃時、敵全体に3ダメージを与え、味方全体の攻撃力を永続で2上げる', image: 'card-light-whitegriffon.png', emoji: '🦅' },
  // ---- 初心者ガチャ用の新規カード ----
  fire_flarelion:      { name: 'マグマタートル', element: 'fire', rarity: 'rare', cost: 3, atk: 4, hp: 3, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'extraDamage', value: 1 }, skill: '攻撃時、追加で1ダメージ', image: 'card-fire-magmaturtle.png', emoji: '🐢' },
  nature_venomscorpion: { name: 'グリーンスタグ', element: 'nature', rarity: 'rare', cost: 3, atk: 3, hp: 3, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'poisonChance', value: 1, chance: 0.6, turns: 2 }, skill: '攻撃時、60%の確率で毒（2ターン）を付与する', image: 'card-nature-greenstag.png', emoji: '🦌' },
  light_lightguardian:  { name: 'グリフィン', element: 'light', rarity: 'rare', cost: 3, atk: 2, hp: 4, role: 'defender', skillTag: { trigger: 'onPlay', effect: 'shieldAllAllies', value: 1 }, skill: '場に出た時、味方全体にシールド1を付与する', image: 'card-light-griffin.png', emoji: '🦅' },
  ...
  light_arcknight:      { name: '光輝の大天使ルシエル', element: 'light', rarity: 'legend', cost: 6, atk: 9, hp: 6, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'aoeDamage', value: 3 }, skill: '攻撃時、敵全体に3ダメージを与える（聖なる裁きの光）', image: 'card-light-luciel.png', emoji: '👼' },
  ...
  fire_flameboar:      { name: 'ケルベロス',     element: 'fire',   rarity: 'rare', cost: 3, atk: 5, hp: 3, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'aoeDamage', value: 2 }, skill: '攻撃時、敵全体に2ダメージを与える（三つの首による猛攻）', image: 'card-fire-cerberus2.png', emoji: '🐕' },
  ...
  fire_cerberus:        { name: 'ヘスティア', element: 'fire',   rarity: 'epic', cost: 4, atk: 4, hp: 6, role: 'defender', skillTag: { trigger: 'onPlay', effect: 'healAllAllies', value: 2 }, skill: '場に出た時、味方全体のHPを2回復する（家庭の炉を守る女神）', image: 'card-fire-hestia.png', emoji: '🔥' },
  ...
  light_fairylumina:     { name: 'アテナ', element: 'light',  rarity: 'legend', cost: 5, atk: 4, hp: 8, role: 'defender', skillTag: { trigger: 'onPlay', effect: 'healAndShieldAllies', value: 2, shieldValue: 3 }, skill: '場に出た時、味方全体のHPを2回復し、シールド3を付与する（知略の女神の加護）', image: 'card-light-athena.png', emoji: '🦉' },
  dark_deathwhisperer:   { name: 'ハデス',   element: 'dark',   rarity: 'legend', cost: 6, atk: 8, hp: 7, role: 'attacker', skillTag: { trigger: 'onAttack', effect: 'drainEnemyCost', value: 2 }, skill: '攻撃で相手を撃破した時、相手のコストを2消費させる（冥府の王の裁定）', image: 'card-dark-hades.png', emoji: '💀' },
...
function startBattle(stage) {
  ...
  battle = {
    ...
    playerMaxCost: 2, enemyMaxCost: 2,
    playerCost: 2, enemyCost: 2,
...
function applySkillTag(unit, trigger, isPlayerSide) {
  ...
  if (tag.effect === 'healSelf') {
    ...
    // 【フォレストウルフ】場に出た時、敵全体にダメージ＋毒を付与し、味方全体にシールドを付与
    const opposingField = isPlayerSide ? battle.enemyField : battle.playerField;
    const selector = isPlayerSide ? '#battle-enemy-field .cg-field-slot' : '#battle-player-field .cg-field-slot';
    ...
    // 【炎帝ヴァルカン】場に出た時、敵全体にダメージ＋火傷＋攻撃力ダウン（永続）
    const opposingField = isPlayerSide ? battle.enemyField : battle.playerField;
    const selector = isPlayerSide ? '#battle-enemy-field .cg-field-slot' : '#battle-player-field .cg-field-slot';
    opposingField.forEach((u, i) => {
      if (!u) return;
    ...
    // 【深海のセイレーン】場に出た時、味方全体を回復＋シールド付与、敵全体の攻撃力ダウン（永続）
    field.forEach(u => {
      if (!u) return;
      if (!healBlocked) {
        const maxHp = u.def.hp + (u.hpBonus || 0);
...
function attackTarget(attackerIdx, targetIdx) {
  ...
  if (targetIdx === null) {
    ...
    if (tag && tag.effect === 'aoeDamageStunHeal') {
      // 【ストームクラーケン】攻撃時、敵全体にダメージ＋行動不能、味方全体を回復
      battle.enemyField.forEach(u => {
        if (!u) return;
        u.curHp -= mitigateIncomingDamage(u, tag.value);
        if (u.curHp > 0) u.stunned = true;
    ...
    if (tag && tag.effect === 'aoeDamageAtkUpAllies') {
      // 【ウィンドレンジャー】攻撃時、敵全体にダメージ＋味方全体の攻撃力アップ（永続）
    ...
    if (tag && tag.effect === 'aoeDamageStunDrainCost') {
      // 【ダークソーサレス】攻撃時、敵全体にダメージ＋行動不能、相手のコストを消費
      battle.enemyField.forEach(u => {
        if (!u) return;
        u.curHp -= mitigateIncomingDamage(u, tag.value);
        if (u.curHp > 0) u.stunned = true;
...
const INTERACTIVE_TUTORIAL_STEPS = [
  ...
  { findTarget: findTutorialMonsterHandCard,
    matches: (el) => {
      ...
      const def = id && CARD_DEFS[id];
      // コストが足りないカードは実際にはタップしても場に出せない（ゲーム側で無視される）ため、
      // 手札に召喚可能なモンスターが無いのにチュートリアルだけ進んでしまう不整合を防ぐ
      return !!(def && (def.type || 'monster') === 'monster' && def.cost <= battle.playerCost);
    },
  ...
  { findTarget: findTutorialReadyAttacker,
    matches: (el) => {
      const card = el.closest('#battle-player-field .cg-field-slot.filled');
      if (!card || !battle) return false;
      const idx = Number(card.dataset.idx);
      const unit = battle.playerField[idx];
      return !!(unit && unit.canAttack);
    },
    text: '自分のターンになったら、⚡マーク付きの攻撃可能なモンスターをタップして選んでみましょう。', hint: '👆 攻撃可能なモンスターをタップ' },
  { findTarget: findTutorialAttackTargetElement,
    matches: (el) => {
      if (!battle || battle.selectedFieldIdx === null) return false;
      const attacker = battle.playerField[battle.selectedFieldIdx];
      if (!attacker) return false;
      const valid = getValidTargets(attacker, battle.enemyField);
      const enemySlot = el.closest('#battle-enemy-field .cg-field-slot');
      if (enemySlot) return valid.indices.includes(Number(enemySlot.dataset.idx));
      return !!(el.closest('#battle-enemy-portrait') && valid.faceAllowed);
    },
    text: '相手のモンスターや本体をタップすると、攻撃を実行できます。試してみましょう。', hint: '👆 攻撃対象をタップ' },
  { passive: true,
    waitFor: () => { const el = document.getElementById('screen-result'); return !!el && el.classList.contains('active'); },
    text: 'あとは自由にバトルを進めて、決着をつけましょう！ モンスターの召喚や攻撃、スペルの使用など、これまで学んだ操作を自由に試せます。', hint: 'バトルを最後まで進めましょう' },
  { selector: '#result-stageselect',
    matches: (el) => !!el.closest('#result-stageselect'),
    text: 'バトルお疲れさまでした！「ステージ選択に戻る」をタップしましょう。', hint: '👆 「ステージ選択に戻る」をタップ' },
  { selector: '#nav-shop',
    matches: (el) => !!el.closest('#nav-shop'),
    text: '最後に「ガチャ」タブをタップして、ガチャ画面を開いてみましょう。', hint: '👆 「ガチャ」タブをタップ' },
  { selector: '.cg-pack-buy[data-pack="beginner"][data-times="1"]',
    matches: (el) => !!el.closest('.cg-pack-buy[data-pack="beginner"][data-times="1"]'),
    text: '「初心者ガチャ」を引いてみましょう。最初の1回は無料です！', hint: '👆 「無料」ボタンをタップ' },
  { selector: '#opening-tap-zone',
    matches: (el) => !!el.closest('#opening-tap-zone'),
    text: '画面をタップして開封しましょう！', hint: '👆 画面をタップして開封' },
  { selector: '#shop-reveal-close',
    matches: (el) => !!el.closest('#shop-reveal-close'),
    text: 'カードを獲得しました！「閉じる」をタップすれば、チュートリアルは完了です。お疲れさまでした！', hint: '👆 「閉じる」をタップ' },
];

// 攻撃可能な（canAttack=trueの）自分のモンスターを対象にする
function findTutorialReadyAttacker() {
  if (!battle || !battle.playerField) return null;
  const idx = battle.playerField.findIndex(u => u && u.canAttack);
  if (idx === -1) return null;
  return document.querySelector(`#battle-player-field .cg-field-slot[data-idx="${idx}"]`);
}

// 攻撃対象（有効な敵モンスター、いなければ敵本体）を対象にする。攻撃者が選択されている場合のみ有効
function findTutorialAttackTargetElement() {
  if (!battle || battle.selectedFieldIdx === null) return null;
  const attacker = battle.playerField[battle.selectedFieldIdx];
  if (!attacker) return null;
  const valid = getValidTargets(attacker, battle.enemyField);
  if (valid.indices.length > 0) {
    return document.querySelector(`#battle-enemy-field .cg-field-slot[data-idx="${valid.indices[0]}"]`);
  }
  if (valid.faceAllowed) return document.getElementById('battle-enemy-portrait');
  return null;
}
...
function findTutorialMonsterHandCard() {
  ...
  const idx = battle.playerHand.findIndex(id => {
    const def = CARD_DEFS[id];
    return def && (def.type || 'monster') === 'monster' && def.cost <= battle.playerCost;
  });
  if (idx === -1) return null;
...
function onTutorialDocumentClick(e) {
  ...
  const step = INTERACTIVE_TUTORIAL_STEPS[interactiveTutorialStepIdx];
  if (!step) return;
  if (step.passive) return; // 自由に操作させるステップ：クリックの制限・ステップ進行判定は行わない（進行はwaitForで別途判定する）
  if (!step.matches(e.target)) {
...
function waitForTutorialTarget(step, attempts) {
  if (!interactiveTutorialActive) return;
  if (step.passive) {
    // 自由に操作させるステップ：スポットライト（マスク）は表示せず、ツールチップのみ画面下部に固定表示する。
    // waitForが真を返したら、クリック操作を待たずに自動で次のステップへ進む
    showPassiveTutorialTooltip();
    if (step.waitFor && step.waitFor()) {
      interactiveTutorialStepIdx++;
      showInteractiveTutorialStep();
      return;
    }
    interactiveTutorialWaiter = setTimeout(() => waitForTutorialTarget(step, attempts + 1), 400);
    return;
  }
...
// 自由操作ステップ用：スポットライト（マスク・リング）は出さず、ツールチップだけを画面下部に固定表示する
function showPassiveTutorialTooltip() {
  ['tutorial-mask-top', 'tutorial-mask-bottom', 'tutorial-mask-left', 'tutorial-mask-right', 'tutorial-spotlight-ring'].forEach(id => {
    document.getElementById(id).classList.add('hidden');
  });
