...
const CARD_DEFS = {
  ...
  fire_imp:       { name: 'フレイムインプ',   element: 'fire',   rarity: 'normal', cost: 1, atk: 2, hp: 1,  role: 'attacker', skill: '', image: null, emoji: '👹' },
  ...
  light_angel:    { name: 'ガーディアンエンジェル', element: 'light', rarity: 'epic', cost: 4, atk: 3, hp: 6, role: 'defender', skillTag: { trigger: 'onPlay', effect: 'healAllAllies', value: 1 }, skill: '場に出た時、味方全体のHPを1回復', image: 'card-light-angel.png', emoji: '👼' },
  ...
  nature_elfunicorn:  { name: 'エルフユニコーン', element: 'nature', rarity: 'rare',  cost: 3, atk: 2, hp: 5, role: 'defender', skillTag: { trigger: 'onPlay', effect: 'healAllAllies', value: 1 }, skill: '場に出た時、味方全体のHPを1回復', image: 'card-nature-elfunicorn.png', emoji: '🦄' },
  ...
  nature_sylph:       { name: 'シルフ',           element: 'nature', rarity: 'rare',  cost: 2, atk: 2, hp: 3, role: 'defender', skillTag: { trigger: 'onPlay', effect: 'drawCard', value: 1 }, skill: '場に出た時、カードを1枚引く', image: 'card-nature-sylph.png', emoji: '🧚' },
  dark_demonlord:     { name: 'デモンロード',     element: 'dark', rarity: 'legend',  cost: 6, atk: 6, hp: 7, role: 'attacker', skillTag: { trigger: 'onKillAttack', effect: 'drainEnemyCost', value: 1 }, skill: '敵モンスターを撃破した時、相手のコストを1消費させる', image: 'card-dark-demonlord.png', emoji: '😈' },
...
const STAGES = [
  { id: 1, name: '森を彷徨う影', portrait: '🐺', hp: 16, spellChance: 0.05, bgTheme: 'forest',
    weights: { normal: 95, rare: 5, epic: 0, legend: 0 }, rewardGold: 80, rewardGems: 5, trophyDelta: 20,
    storyIntro: [
      { speaker: 'ナレーター', portrait: '📖', text: '呪いを喰らう獣＝モンスターが跋扈する時代。小さな村を守るため、若き調教師が森へと足を踏み入れる。' },
      { speaker: 'ナレーター', portrait: '📖', text: '村の外れで、彷徨う影に遭遇した。' },
    ],
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '一体、また一体。村を脅かす影を退け、束の間の平穏を取り戻した。' } },
  { id: 2, name: '素材集めの試練', portrait: '🍃', hp: 18, spellChance: 0.08, bgTheme: 'snow',
    ...
    storyIntro: [
      ...
      { speaker: 'ナレーター', portrait: '📖', text: '荒れた雪原に、素材を守るモンスターの気配があった。' },
    ],
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '手に入れた呪素材は、まだ温かく、確かな力を宿していた。' } },
  { id: 3, name: '深淵よりの囁き', portrait: '🔮', hp: 22, spellChance: 0.13, bgTheme: 'cave',
    ...
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '囁きは静まった。だが、これほどの呪いが集まる理由が、どうしても引っかかる。' } },
  { id: 4, name: '竜の血を継ぐ者', portrait: '🐲', hp: 28, spellChance: 0.19, bgTheme: 'volcano',
    ...
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '古き竜の力もまた、呪いに触れれば牙を剥く。それでも、この地に平和が戻った。' } },
  { id: 5, name: '森の女王', portrait: '👑', hp: 34, spellChance: 0.26, bgTheme: 'castle',
    ...
    storyVictory: { speaker: '森の女王', portrait: '👑', text: '……見事だ。だが人の子よ、覚えておくがいい。呪いの源は、まだ遥か先にある。' } },
  { id: 6, name: '月下の斥候', portrait: '🌙', hp: 40, spellChance: 0.22, bgTheme: 'moonshadow',
    ...
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '廃墟の奥に、まだ息づく者たちがいた。ここから、村と国の復興が始まる。' } },
  { id: 7, name: '荒野の守護者', portrait: '🍃', hp: 46, spellChance: 0.25, bgTheme: 'emerald',
    ...
    storyVictory: { speaker: '荒野の守護者', portrait: '🍃', text: '……お前のような者がいるなら、まだ望みはあるのかもしれん。' } },
  { id: 8, name: '氷の試練', portrait: '❄️', hp: 52, spellChance: 0.28, bgTheme: 'frost',
    ...
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '試練を越えた証に、祠は静かに光を放ち、新たな絆が芽生えた。' } },
  { id: 9, name: '業火の番人', portrait: '🔥', hp: 58, spellChance: 0.31, bgTheme: 'inferno2',
    ...
    storyVictory: { speaker: '業火の番人', portrait: '🔥', text: '……我が炎が届かぬとはな。女帝様に伝えよ、危険な者が来ると。' } },
  { id: 10, name: '月影の女帝', portrait: '👸', hp: 66, spellChance: 0.34, bgTheme: 'empress',
    ...
    storyVictory: { speaker: '月影の女帝', portrait: '👸', text: '……見事。そなたになら話そう。この呪いの根は「四天王」、そしてその先の魔王城にある。' } },
  { id: 11, name: '四天王・爪の将', portrait: '🦅', hp: 74, spellChance: 0.36, bgTheme: 'cave',
    ...
    storyVictory: { speaker: '爪の将', portrait: '🦅', text: '……我が爪を退けるか。だが、我らは四人。まだ三人残っている。' } },
  { id: 12, name: '四天王・鎧の将', portrait: '🐢', hp: 82, spellChance: 0.38, bgTheme: 'frost',
    ...
    storyVictory: { speaker: '鎧の将', portrait: '🐢', text: '……鎧が、砕けた。人の子よ、お前は本物だ。' } },
  { id: 13, name: '四天王・毒の将', portrait: '🐍', hp: 90, spellChance: 0.40, bgTheme: 'emerald',
    ...
    storyVictory: { speaker: '毒の将', portrait: '🐍', text: '……毒が効かぬとは。面白い人の子だこと。' } },
  { id: 14, name: '四天王・炎の将', portrait: '🐉', hp: 98, spellChance: 0.42, bgTheme: 'inferno2',
    ...
    storyVictory: { speaker: '炎の将', portrait: '🐉', text: '……我が炎すら凌ぐか。もはや止める者はいない。魔王城へ行くがいい。' } },
  { id: 15, name: '四天王を統べる者', portrait: '⚔️', hp: 112, spellChance: 0.45, bgTheme: 'moonshadow',
    ...
    storyVictory: { speaker: '四天王を統べる者', portrait: '⚔️', text: '……敗北を認めよう。魔王城への門は、もう開いている。行け。' } },
  { id: 16, name: '魔王城・門番', portrait: '🗿', hp: 122, spellChance: 0.47, bgTheme: 'castle',
    ...
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '門は開いた。魔王城の内部へ、一歩ずつ近づいていく。' } },
  { id: 17, name: '魔王城・呪術師', portrait: '💀', hp: 132, spellChance: 0.49, bgTheme: 'cave',
    ...
    storyVictory: { speaker: '呪術師', portrait: '💀', text: '……私の呪詛が届かぬか。お前もまた、何かに選ばれし者か。' } },
  { id: 18, name: '魔王城・処刑人', portrait: '🪓', hp: 142, spellChance: 0.51, bgTheme: 'empress',
    ...
    storyVictory: { speaker: '処刑人', portrait: '🪓', text: '……この斧が、届かぬだと……。魔王様、お気をつけを……。' } },
  { id: 19, name: '魔王城・影の宰相', portrait: '🕶️', hp: 152, spellChance: 0.53, bgTheme: 'frost',
    ...
    storyVictory: { speaker: '影の宰相', portrait: '🕶️', text: '……見事。だが、玉座の間で待つものを見て、お前は後悔するだろう。' } },
  { id: 20, name: '魔王', portrait: '👹', hp: 170, spellChance: 0.56, bgTheme: 'inferno2',
    ...
    storyVictory: { speaker: '魔王', portrait: '👹', text: '……ぐ、あ……。だが……私を倒しても、呪いは……消えない……本当の元凶は、まだ……。' } },
  { id: 21, name: '崩れゆく世界', portrait: '🌑', hp: 185, spellChance: 0.58, bgTheme: 'moonshadow',
    ...
    storyIntro: [
      ...
      { speaker: 'ナレーター', portrait: '📖', text: '世界の歪みの中から、新たな影が姿を現した。' },
    ],
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '倒しても倒しても、次々と現れる呪い。何かが、根本から間違っている。' } },
  { id: 22, name: '黒百合の巫女', portrait: '🥀', hp: 200, spellChance: 0.60, bgTheme: 'empress',
    ...
    storyVictory: { speaker: '黒百合の巫女', portrait: '🥀', text: '……もういい。あとは、あなた自身の目で確かめなさい。' } },
  { id: 23, name: '記憶の断片', portrait: '🕸️', hp: 215, spellChance: 0.62, bgTheme: 'cave',
    ...
    storyVictory: { speaker: 'ナレーター', portrait: '📖', text: '全ての記憶が繋がった。女神は、かつて世界を救おうとして──呪われたのだ。' } },
  { id: 24, name: '女神の影', portrait: '✨', hp: 230, spellChance: 0.64, bgTheme: 'castle',
    ...
    storyIntro: [
      ...
      { speaker: '女神の影', portrait: '✨', text: 'かつて白百合だった私は、世界を守るため、自ら呪いを受け入れた。もう戻れない。' },
    ],
    storyVictory: { speaker: '女神の影', portrait: '✨', text: '……ありがとう。これで、本当の私に会いに行ける。' } },
  { id: 25, name: '黒百合の女神', portrait: '🖤', hp: 280, spellChance: 0.68, bgTheme: 'purification',
    ...
    storyVictory: { speaker: '黒百合の女神', portrait: '🌸', text: '……ああ、光が見える。ありがとう。この世界に、もう一度「Lis Noir」を──白と黒の百合を、咲かせて。' } },
];
